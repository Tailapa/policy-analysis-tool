  ...
  return (
    <header className={`no-print border-b px-6 py-5 flex flex-col md:flex-row md:items-center justify-between gap-4 max-w-7xl mx-auto w-full transition-all ${
      ...
      <div className="flex items-center gap-4 flex-wrap md:flex-nowrap">
        ...
        {/* Brand Block */}
        <div>
          <h1 className={`text-xl font-bold font-display tracking-tight ${isDark ? 'text-zinc-100' : 'text-zinc-900'}`}>
            India Governance Watch
          </h1>
          <p className="text-xs text-zinc-500 font-medium">Viksit Bharat's policy and administrative developments</p>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 self-end md:self-auto flex-wrap sm:flex-nowrap w-full sm:w-auto">
        ...
        <div className="flex items-center gap-2">
          ...
          {isAdmin ? (
            <div className="flex items-center gap-1.5">
              <button
                ...
                className={`px-3 py-1 text-[10px] font-bold border rounded-full transition-all cursor-pointer flex items-center gap-1 ${
                  activeTab === 'Upload'
                    ? isDark
              ...
              <button
                onClick={onLogout}
                className={`p-1.5 rounded-full border shadow-inner transition-all cursor-pointer flex items-center justify-center ${
                  isDark
          ...
          <div className={`flex items-center gap-1 border rounded-full p-1 shadow-inner transition-all ${
