...
async def test_list_items_shape_matches_frontend(client, seeded_item):
    ...
    assert set(item.keys()) == {
        ...
        "subtype", "status", "impact", "date", "dateValue",
        "sources", "tags", "isDraft", "financialOutlay", "needsMinistryReview",
    }
...
async def test_null_source_url_serializes_as_empty_string(client, test_db, seeded_ministry, seeded_issue):
